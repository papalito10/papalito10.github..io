...
var map = new ol.Map({
    ...
    view: new ol.View({
         maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:26918',
            extent: [562996.375999, 0.000000, 12793375.260170, 4529951.985862],
            units: 'm'})
    })
});
...
map.getView().fit([465394.554377, 4448226.861692, 666049.207946, 4571292.175535], map.getSize());
